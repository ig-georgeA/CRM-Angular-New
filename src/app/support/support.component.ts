...
import { IGX_CARD_DIRECTIVES, IGX_GRID_DIRECTIVES, IgxAvatarComponent, IgxButtonDirective, IgxIconComponent } from '@infragistics/igniteui-angular';
...
@Component({
  ...
  imports: [IGX_CARD_DIRECTIVES, IGX_GRID_DIRECTIVES, IgxPieChartModule, IgxCategoryChartModule, IgxIconComponent, IgxButtonDirective, IgxAvatarComponent],
...
export class SupportComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public cRMAIGeneratedDataService: CRMAIGeneratedDataService,
  ) {}
